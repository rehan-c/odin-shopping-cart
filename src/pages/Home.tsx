    ...
    return (
        <div className="card" style={{padding: "2rem 0rem 3rem 0rem"}}>
            ...
            <div className="card" style={{ width: "50vw", marginLeft: "auto", marginRight: "auto", textAlign: "center" }}>
                <img src="/bmw-4-series.jpg" className="card-img-top" alt="car" style={{ width: "60%", height: "60%", marginLeft:"auto", marginRight:"auto", marginTop: "1rem", borderRadius: "10px" }}></img>
